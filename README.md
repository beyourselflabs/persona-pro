<p align="center">
  <img src="media/banner.png" alt="Persona — Attribute Cursor costs to projects, not the seat" width="100%" />
</p>
...
**Pro** unlocks a project ledger with cost and model breakdown per project. Forecast and reconcile spend by project and job code.

**Pro + Cloud** (coming soon) rolls the ledger up across the team: token counts and costs per project for billables and forecasting.
...
2. Email [hello@beyourselflabs.com](mailto:hello@beyourselflabs.com?subject=Persona%20Pro%20license) to request a license.
3. In Cursor, run **Persona: Enter Pro License** and paste your key.
